...
![image-20250428201218900](README.assets/image-20250428201218900.png)

# 系统架构

![image-20250429011331812](README.assets/image-20250429011331812.png)
...
一般的服务发现基于注册中心实现，但是Kubernetes内部使用etcd管理Pod，并且提供service管理一组相同功能的节点。所以本项目使用Kubernetes服务发现替代传统SpringCloud服务发现，避免冗余。
 ...
 ![image-20250429010442831](README.assets/image-20250429010442831.png)

 <img src="README.assets/image-20250429010540282.png" alt="image-20250429010540282" style="zoom: 80%;" />

### 节点扩缩容

使用Deployment动态管理节点数量，支持节点动态扩缩容，提高系统吞吐量

 ![image-20250429010822233](README.assets/image-20250429010822233.png)

 ![image-20250429011045159](README.assets/image-20250429011045159.png)
